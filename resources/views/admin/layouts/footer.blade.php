...
<script src="{{asset('assets/plugins/custom/fullcalendar/fullcalendar.bundled1cf.js?v=7.1.6')}}"></script>
<!--end::Page Vendors-->
<!--begin::Page Scripts(used by this page)-->
<script src="{{asset('assets/js/pages/widgetsd1cf.js?v=7.1.6')}}"></script>
<!--end::Page Scripts-->
@yield('script')
</body>
<!--end::Body-->

<!-- Mirrored from preview.keenthemes.com/metronic/demo1/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 09 Dec 2020 08:37:52 GMT -->
</html>
